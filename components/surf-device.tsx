...
export function SurfDevice({ onClose }: SurfDeviceProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Device Body */}
      <div className="relative w-[420px] h-auto metallic-grain rounded-[32px] flex flex-col border border-[#C8CACD] dark:border-gunmetal-800 shadow-[inset_0_0_0_1.5px_rgba(255,255,255,0.8),4px_4px_8px_rgba(0,0,0,0.1),inset_2px_2px_4px_rgba(255,255,255,0.9),inset_-2px_-2px_4px_rgba(0,0,0,0.06)] dark:shadow-[inset_0_0_0_1.5px_rgba(255,255,255,0.06),4px_4px_8px_rgba(0,0,0,0.3),inset_2px_2px_4px_rgba(255,255,255,0.08),inset_-2px_-2px_4px_rgba(0,0,0,0.3)] font-mono overflow-hidden pb-7 z-[10]">
            ...
            <svg width="100%" height="30" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="hole-pattern" width="5" height="5" patternUnits="userSpaceOnUse">
                  <circle cx="2.5" cy="2.5" r="1.2" className="fill-[#CCCED1] dark:fill-[#1f2125]" />
                  <circle cx="2.5" cy="2.8" r="1.2" fill="none" className="stroke-[rgba(0,0,0,0.08)] dark:stroke-[rgba(255,255,255,0.08)]" strokeWidth="0.4" />
                </pattern>
              </defs>
