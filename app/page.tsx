        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <div className="text-base" style={{ lineHeight: 1.5, color: "var(--color-fg-muted)" }}>
              ...
              <DirectionalUnderline as="a" href="https://example.com" target="_blank" className="font-medium inline-flex items-center whitespace-nowrap text-base" style={{ color: 'var(--color-fg)' }} onMouseEnter={(e) => { const c = shadersCardRef.current; if (c) { const rect = (e.currentTarget as HTMLElement).getBoundingClientRect(); c.style.left = `${e.clientX - 128}px`; c.style.top = `${rect.top - 144 - 6}px`; c.style.opacity = '1'; c.style.transform = 'translateY(0) scale(1)'; } }} onMouseMove={(e) => { const c = shadersCardRef.current; if (c) { c.style.left = `${e.clientX - 128}px`; } }} onMouseLeave={() => { const c = shadersCardRef.current; if (c) { c.style.opacity = '0'; c.style.transform = 'translateY(6px) scale(0.97)'; } }}>Shaders Playground<svg className="ml-[0.3em] mr-[0.15em] size-[0.55em]" fill="none" viewBox="-1 -1 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M1.004 9.166 9.337.833m0 0v8.333m0-8.333H1.004" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" /></svg></DirectionalUnderline>,{" "}
